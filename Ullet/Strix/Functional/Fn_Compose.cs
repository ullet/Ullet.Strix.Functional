...
namespace Ullet.Strix.Functional
{
  ...
  public static partial class Fn
  {
    ...
    public static Func<TA, TC> After<TA, TB, TC>(
      this Func<TB, TC> outer, Func<TA, TB> inner) => Compose(outer, inner);
    ...
    public static Func<TB> After<TA, TB>(
      this Func<TA, TB> outer, Func<TA> inner) => Compose(outer, inner);
    ...
    public static Func<TA, TC> Compose<TA, TB, TC>(
      this Func<TB, TC> outer, Func<TA, TB> inner) => a => outer(inner(a));
    ...
    public static Func<TB> Compose<TA, TB>(
      this Func<TA, TB> outer, Func<TA> inner) => () => outer(inner());
    ...
    public static Func<TB> Before<TA, TB>(
      this Func<TA> inner, Func<TA, TB> outer) => ComposeReverse(inner, outer);
    ...
    public static Func<TA, TC> ComposeReverse<TA, TB, TC>(
      this Func<TA, TB> inner, Func<TB, TC> outer) => outer.Compose(inner);
    ...
    public static Func<TB> ComposeReverse<TA, TB>(
      this Func<TA> inner, Func<TA, TB> outer) => outer.Compose(inner);
    ...
    public static Func<T, T> Compose<T>(params Func<T, T>[] funcs)
      => Compose((IEnumerable<Func<T, T>>)funcs);
    ...
    public static Func<T, T> Compose<T>(this IEnumerable<Func<T, T>> funcs)
      => funcs.Aggregate((Func<T, T>)(t => t), After);
    ...
    public static Func<T, T> ComposeReverse<T>(params Func<T, T>[] funcs)
      => ComposeReverse((IEnumerable<Func<T, T>>)funcs);
